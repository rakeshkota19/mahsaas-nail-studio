...
const PromotionsSection = () => {
  ...
  return (
    <section id="services" ref={sectionRef} className="py-20 bg-gradient-to-br from-pastel-pink/10 via-pink-50 to-pastel-pink/20 relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {/* Student Discount */}
          <Card className={`group hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 overflow-hidden border-0 transform ${
          ...
          {/* First-Time Guest */}
          <Card className={`group hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 overflow-hidden border-0 transform delay-200 ${
            isVisible ? 'animate-scale-in' : 'opacity-0 scale-95'
          }`}>
            <div className="relative">
              ...
              <CardContent className="p-8 text-center relative">
                ...
                <div className="text-2xl font-light text-pastel-pink mb-4 leading-tight">
                  <span className="animate-pulse">Free Nail Art</span><br />
